...
export type GetProductByHandleQuery = { __typename?: 'QueryRoot', product?: { __typename?: 'Product', id: string, title: string, handle: string, priceRange: { __typename?: 'ProductPriceRange', minVariantPrice: { __typename?: 'MoneyV2', amount: any, currencyCode: CurrencyCode } }, images: { __typename?: 'ImageConnection', edges: Array<{ __typename?: 'ImageEdge', node: { __typename?: 'Image', url: any, altText?: string | null | undefined } }> }, variants: { __typename?: 'ProductVariantConnection', edges: Array<{ __typename?: 'ProductVariantEdge', node: { __typename?: 'ProductVariant', title: string, availableForSale: boolean, image?: { __typename?: 'Image', url: any, altText?: string | null | undefined } | null | undefined, selectedOptions: Array<{ __typename?: 'SelectedOption', name: string, value: string }>, priceV2: { __typename?: 'MoneyV2', amount: any, currencyCode: CurrencyCode } } }> } } | null | undefined };
...
/**
 * __useGetProductByHandleQuery__
 *
 * To run a query within a React component, call `useGetProductByHandleQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetProductByHandleQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useGetProductByHandleQuery(baseOptions?: Apollo.QueryHookOptions<GetProductByHandleQuery, GetProductByHandleQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetProductByHandleQuery, GetProductByHandleQueryVariables>(GetProductByHandleDocument, options);
      }
export function useGetProductByHandleLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetProductByHandleQuery, GetProductByHandleQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetProductByHandleQuery, GetProductByHandleQueryVariables>(GetProductByHandleDocument, options);
        }
export type GetProductByHandleQueryHookResult = ReturnType<typeof useGetProductByHandleQuery>;
export type GetProductByHandleLazyQueryHookResult = ReturnType<typeof useGetProductByHandleLazyQuery>;
export type GetProductByHandleQueryResult = Apollo.QueryResult<GetProductByHandleQuery, GetProductByHandleQueryVariables>;
